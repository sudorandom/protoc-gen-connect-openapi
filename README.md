...
| features                   | `connectrpc;google.api.http;twirp;gnostic;protovalidate` | Semicolon-separated list of features to enable. Default: `connectrpc;google.api.http;gnostic;protovalidate`. If this option is used, only the specified features will be enabled. |
