...
| int64-as-string            | - | Document 64-bit integer fields as `string` instead of the `[integer, string]` union. Protobuf JSON serialises them as strings; the union is an OpenAPI 3.1 construct that 3.0-era tooling rejects or widens to `any`.                                          |
