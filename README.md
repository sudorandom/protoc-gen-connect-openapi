...
| plugins                    | `connectrpc;google.api.http;twirp;gnostic;protovalidate` | Semicolon-separated list of plugins to enable. Default: `connectrpc;google.api.http;gnostic;protovalidate`. If this option is used, only the specified plugins will be enabled. |
